...
CrystalPlace::CrystalPlace() : IModule(0, Category::COMBAT, "p100 java CA by JohnTWD // FatMC#1209") {
...
bool cmpDup(CrystalPlacements E1, CrystalPlacements E2) {
	bool cmpType = not(moduleMgr->getModule<CrystalPlace>()->safetyFirst);
